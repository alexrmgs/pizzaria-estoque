...
// volume (cada chamada curta evita timeout e é reprocessada se falhar). 1 dia
// só — loja de muito movimento (ex: São Cristóvão, ~1000 pedidos/dia) já
// estourava o tempo limite da função com pedaços de 3 dias.
const CHUNK_DAYS = 1;
